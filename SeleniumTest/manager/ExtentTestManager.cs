...
namespace SeleniumTest.manager
{
    public class ExtentTestManager
    {
		...
		public static ExtentTest CreateTest(string testName, string description = null)
		{
			lock (_synclock)
			{
				_parentTest.Value = ExtentService.Instance.CreateTest<Feature>(testName, description);
		...
		public static ExtentTest CreateMethod(string parentName, string testName, string description = null)
		{
			...
			lock (_synclock)
			{
				...
				{
					parentTest = ExtentService.Instance.CreateTest<Feature>(testName);
				...
				_childTest.Value = parentTest.CreateNode<Scenario>(testName, description);
				_childTest.Value.CreateNode<When>("Test");
